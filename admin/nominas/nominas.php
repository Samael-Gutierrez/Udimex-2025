...
while($fila=mysqli_fetch_assoc($sql)){
    $datos=$datos."<tr><td>".$fila['concepto']."</td><td>".$fila['horas']."</td><td>".$fila['cantidad']."</td>
...
while($fila=mysqli_fetch_assoc($sql)){
    $registro=$registro."<tr><td>".$fila['concepto']."</td><td>".$fila['cantidad']."</td>
...
<div class="logo-container">
    ...
    <img src="fpdf/udimex.png" alt="Logo" class="logo">
     ...
     <div class="col-6"> 
        <form class="p-3 mx-auto" method="POST" action="guarda_deduccion.php" onsubmit="return validarFormularioDeduccion()">
            ...
            <div class="mb-3">
                ...
                <input list="deduccion" name="concepto" id="concepto_deduccion" class="col-12">
                    <?php echo $deduccion; ?>
            </div>
