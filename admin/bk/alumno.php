...
<html>
<head>
	<title>Registro Alumno - Instituto Kambes </title>
...
if ($_POST){
	...
	$datos=alumno_nuevo($nom,$ap,$am,$correo,$tel,$cel,$sexo,$e_civil,$f_na,$calle,$colonia,$numero,$municipio,$cp,$colegiatura);
		...
		echo "
			<div id='cuerpo'>
				...
				<form method='POST'>
					...
					Municipio:<br><input type='text' name='municipio' id='caja_texto'><br>
					Codigo Postal:<br><input type='text' name='cp' id='caja_texto'><br>
					Colegiatura:<br><input type='text' name='colegiatura' id='caja_texto'><br>
					<p align='center'>
					&nbsp; &nbsp; &nbsp; &nbsp;
