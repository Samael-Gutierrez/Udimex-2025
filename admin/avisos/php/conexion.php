<?php
    function completa($consulta){
      //  $base=mysqli_connect("localhost","root","","alerta");
    ...
    function cuenta_mensajes($id){
        $consulta="SELECT count(id_destinatario) as r from destinatario where id_usuarios=$id and estados=0";
