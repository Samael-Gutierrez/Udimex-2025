...
<html lang="es">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
      <a class="navbar-brand" href="#">Alvaro</a>
      ...
      <div class="starter-template">
          ...
          <p class="lead">
              ...
              <form name="frmNotification" id="frmNotification" action="php/agregarnotificacion.php" method="POST" >
                ...
                <div class="checador">
                <input type="checkbox"  value= $id name= destinatario[] /><label>Vianney</label>
                
                <input type="checkbox"  value= $id name= destinatario[]/><label>Alfredo</label>
              
                <input type="checkbox" value= $id name= destinatario[]/><label>Samael</label>
                
                <input type="checkbox" value= $id name= destinatario[]/><label>Itzel</label>
                
                <input type="checkbox" value= $id name= destinatario[]/><label>Alondra</label>
