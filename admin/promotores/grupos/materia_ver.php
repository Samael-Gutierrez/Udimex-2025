...
<?php
	...
	$i=0;
	$al="Los alumnos que pertenecen a este grupo son:<table border='0' bgcolor='#2e343d'><tr bgcolor='#dc748c'><th>#</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>Nombre</th><th></th></tr>";
	$datos=b_algr($_GET['id']);
	while($fila=mysqli_fetch_assoc($datos)){
		$i=$i+1;
		$al=$al."<tr bgcolor='#748cb0'><td>$i</td><td>".$fila['ap_pat']."</td><td>".$fila['ap_mat']."</td><td>".$fila['nombre']."</td><td>
