<?php
    ...
    include($dir."db/publicidad.php");
      ...
      $adicional="<link rel='stylesheet' href='css/newEstilos.css'><link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css'>";
   cabeza("Nueva Publicidad - Udimex",$adicional,0);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['imagen']['name'])) {
        ...
        if ($extencion[1] == "jpg" || 
            ...
            añadirPublicacion($nombre, $contenido, $imagen, $prioridad, $n_grupos, $lugar,$_SESSION["ad_id"]);
            
		header("localtion:index.php");
        } else {
            echo "El formato " . $extencion[1] . " no es válido. Si el formato es de imagen verifica que el nombre NO contenga puntos";
        }
    }
}
?>
...
<form class="formulario" method="post" enctype="multipart/form-data">
    ...
    <div class="div-lugar1">
        ...
        <select class="taman-text2 select-color separa tamano" name="lugar">
            <option value=0>Local y Foráneo</option>
            <option value=1>Sólo Local</option>
        </select>
        </div>
    </div>
