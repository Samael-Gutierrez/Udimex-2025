<?php
   ...
   include("funciones/pagination.php");
...
<body>
    ...
    <table  id="table-container" width="100%" class="table-container">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td class="td-nombre-y-boton"><?php echo $reg['nombre'] ?></td>
                    <td class="scroll td-contenido"><?php echo $reg['contenido'] ?></td>
    ...
    <div class="container-botones">
        ...
        <section class="col-md-12 text-center s-pagination">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination pagination-lg pager" id="developer_page">
            ...
            <?php else:?>
                <li class="page-item tamano-pagination">
                <a class="page-link tamano-pagination" href="index.php?pagina=<?php  echo $pagina-1?>" aria-label="Anterior">
                <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <?php
                ...
                for($i=1; $i<=$numeropaginas; $i++){  
                    if($pagina==$i){
                        echo '<li class="active page-item active tamano-pagination"><a class="page-link tamano-pagination" href="index.php?pagina='.$i.'">'.$i.'</a></li>';
                    }else{
                        echo '<li page-item active"><a class="page-link tamano-pagination" href="index.php?pagina='.$i.'">'.$i.'</a></li>';
                    } 
                }
            ...
            <?php else:?>
                <li class="page-item"><a class="page-link tamano-pagination" href="index.php?pagina=<?php echo $pagina+1?>" aria-label="Siguiente">
                <span aria-hidden="true">&raquo;</span></a>
            </li>
                <?php endif;?>
        </ul>
