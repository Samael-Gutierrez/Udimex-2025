...
echo "
    <div class='register-form position-relative'>
        <button class='btn btn-secondary position-absolute top-0 start-100 translate-middle' onclick='redireccionar();'>Volver</button>
        ...
        <form id='formDetalles'>
            <div class='mb-3'>
                ...
                <input name='calificacion' id='calificacion' type='number' value='$calificacion' min='0' max='10' step='.5' class='form-control' placeholder='Seleccione la calificación alcanzada de 0 a 10'>
            </div>

            <div class='mb-3'>
                <label class='form-label'>Comentario del profesor:</label>
                <textarea name='comentario' class='form-control' placeholder='Coloque un mensaje para su alumno.'>$comentario_profe</textarea>
            </div>

            <input name='id_alumno' type='hidden' value='$id_alumno'>
            <input name='tarea' type='hidden' value='$id_tarea'>
...
?>
    ...
    <script>
        ...
        calificacion.addEventListener("blur", () => {
