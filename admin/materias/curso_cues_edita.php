...
$datos=cues($_GET['tema']," order by id_pregunta");
$i=1;
while($fila=mysqli_fetch_assoc($datos)){
	echo "<tr><td>$i</td><td>".$fila['pregunta']."</td><td>";
	...
	while($fila2=mysqli_fetch_assoc($datos2)){
		...
		echo "<img src='../../general/imagen/$im' width='30px'> ".$fila2['respuesta']."<br>";
	}
...
function accion($id,$tipo){
	...
	echo "<td><form $met $ac>
		...
		<input type='hidden' value='".$_GET['tema']."' name='tema'>
	</form></td>";
}
