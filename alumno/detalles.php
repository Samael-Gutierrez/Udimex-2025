...
while($fila = mysqli_fetch_assoc($getDetails)){
    echo "
        <div class='register-form position-relative'>
            <a class='btn btn-secondary position-absolute top-0 start-100 translate-middle' href='calificaciones.php?id=$id&grupo=$grupo'>Volver</a>
            ...
            <div class='mb-3'>
                ...
                <input name='calificacion' type='number' value='".$fila['calificacion']."' min='0' max='10' step='.5' class='form-control' disabled placeholder='Seleccione la calificación alcanzada de 0 a 10'>
            </div>

            <div class='mb-3'>
                <label class='form-label'>Comentario del profesor:</label>
                <textarea disabled name='comentario' class='form-control' placeholder='Coloque un mensaje para su alumno.'>".$fila['comentario']."</textarea>
            </div>
