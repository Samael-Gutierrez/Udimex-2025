...
<html lang='es-MX'>
	<head>
		...
		<link rel='stylesheet' href='".$dir."css/estilo2.css'>
		<link rel='icon' href='".$dir."icono.png' type='image/png' sizes='16x16'>
		$adicional
		<title>$titulo</title>
	</head>
	<body>";
...
//Reemplazar por la función cabeza, es más completa
...
function menu($dir){
	if (isset($_SESSION['g_id'])){
		...
		<a href='".$dir."php/salir.php' style='position:relative; top:-15;'>
			<img src='".$dir."imagen/mal.png' height='45px' class='w3-margin'>
		</a>";
		

		$ligas1="
		<a href='index.php' class='w3-bar-item w3-button'>Mis materias</a>
		<a href='pagos_muestra.php' class='w3-bar-item w3-button'>Mis Pagos</a>
		<a href='calificaciones.php' class='w3-bar-item w3-button'>Mi calificaciones</a>";
		...
		<a href='".$dir."php/salir.php' onclick=\"document.getElementById('id01').style.display='block'\" class='w3-bar-item w3-button'>Cerrar Sesión</a>
		<hr>
		<a href='#planes' src='".$dir."imagen/oferta.png' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/oferta.png' height='17px'  ALIGN=center> Dudas
		</a>
		<a href='#alumnos' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/alumno.png' height='17px'  ALIGN=center> Mis Materias
		</a>
		<a href='#' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/becas.png' height='17px'  ALIGN=center> Mi Agenda
		</a>
		<a href='#' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/otros.png' height='17px'  ALIGN=center> Mis Pagos
		</a>
		<a href='#pie' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/wp_negro.png' height='17px'  ALIGN=center> Mis Documentos
		</a>";
	}
	else{
		$cabeza="
		<a href='https://web.whatsapp.com/send?phone=+527202874706' target='_blank'>
			<img src='".$dir."imagen/wp_color.png' height='50px' class='w3-margin'>
		</a>
		<img src='".$dir."imagen/chat.png' height='45px' class='w3-margin' onclick='ver_chat();'>
		<a href='#' onclick=\"document.getElementById('id01').style.display='block'\">
			<img src='".$dir."imagen/acceso.png' height='45px' class='w3-margin'>
		</a>";
		...
		<hr>
		<a href='#planes' src='".$dir."imagen/oferta.png' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/oferta.png' height='17px'  ALIGN=center> Oferta Educativa
		</a>
		<a href='#alumnos' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/alumno.png' height='17px'  ALIGN=center> Nuestros Alumnos
		</a>
		<a href='#' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/becas.png' height='17px'  ALIGN=center> Becas
		</a>
		<a href='#' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/otros.png' height='17px'  ALIGN=center> Otros Servicios
		</a>
		<a href='#pie' class='w3-bar-item w3-button'>
			<img src='".$dir."imagen/wp_negro.png' height='17px'  ALIGN=center> Contácto
		</a>";
	}
	...
	<div id='logo' class='linea'>
		<div class='linea w3-sans-serif'><img src='".$dir."imagen/logo.png' height='60px' id='imagen_logo'></div>
	</div>
	</header>
	...
	<div align='right' id='chat' onclick='ver_chat();'>
		<img src='".$dir."imagen/chat.png' height='60px' class='w3-margin'>
	</div>


<div class='w3-sidebar w3-bar-block w3-border-right' style='display:none; top:0px' id='mySidebar'>
	<button onclick=\"w3_close()\" class='w3-bar-item w3-large' align='right'> <img src='".$dir."imagen/cerrarmenumovil.png' height='17px'  ALIGN=rigth>  </button>
	$ligas2
</div>
...
function menu_navega($ant,$ad,$mat,$dir){
...
<div id='m_fon' align='center'>
	<div class='w3-row' style='width:500px'>
		...
		<div class='w3-third w3-center m_op' style:'top:100px;'>
			<a href='materia_indice.php?mat=".$mat."'><img src='".$dir."imagen/indice.png' width='50'>
			<h6>&nbsp;</h6>
		</div>
		<div class='w3-third w3-center m_op' style:'top:100px;'>
			$ad
