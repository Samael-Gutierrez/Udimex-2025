...
function b_usuario($nom,$ap,$am,$esc){
	$consulta="
		SELECT a.id_alumno, a.id_carrera, a.f_ingreso, nombre, ap_pat, ap_mat, correo,u.clave, u.id_usuario, u.usuario
...
/*VERIFICAR SI CONSULTA SIGUE EN USO*/
function alumno_nuevo($id,$ins,$men,$cer){
		//$fr=date("Y-m-d");
		//$consulta="INSERT into alumno values($id,$ins,$men,$cer,1,'$fr','$fp',$id,0,0)";
		//completa($consulta);
		echo "verifica que la consulta sea funcional, verifica las dos consultas siguientes 'consultas/alumno.php'";
}
//-------------------------------
...
/*VERIFICAR SI CONSULTA SIGUE EN USO*/
function guarda_alumno2($id,$ins,$fdi,$mo,$carrera,$promotor){
	echo "verifica que la consulta sea funcional, verifica consulta anterior 'consultas/alumno.php'";
	//$consulta="insert into alumno values($id,'$ins','',0,1,'$fdi','',$mo,$id,'',$carrera,$promotor,2);";
	//completa($consulta);
}
//----
